...
names(years) = c("year")
npwordschars <- read.csv("/Users/jiemakel/Downloads/npwordschars-3.csv", header = FALSE)
names(npwordschars) <- c("ISSN","date","page","words","chars")
...
ggsave("~/Downloads/words-by-lang.png", plot, width = 7, height = 4, dpi=300)
