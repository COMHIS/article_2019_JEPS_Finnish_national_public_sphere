...
npcolumns <- read.csv("/Users/jiemakel/Downloads/npcolumns-3.csv", header = FALSE)
names(npcolumns) <- c("ISSN","date","page","wmediancols","mediancols")
...
ggsave("~/Downloads/columns.png", plot, width = 7, height = 4, dpi=300)